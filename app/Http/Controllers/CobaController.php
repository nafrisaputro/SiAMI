...
class CobaController extends Controller
{
    public function index()
    {
        ...
        return view('coba.index', ['coba_data' => $coba_data, 'table_prodi' => $table_prodi, 'table_jurusan' => $table_jurusan]);
    }
    ...
    public function edit($id)
    {
        ...
        $table_prodi = \App\Prodi::all();
        $table_jurusan = \App\Jurusan::all();
        return view('coba/edit', ['coba' => $coba, 'table_prodi' => $table_prodi, 'table_jurusan' => $table_jurusan]);
    }
